...
import 'package:torah_library/otzaria_viewer/text_book/view/combined_view/commentary_list_for_combined_view.dart';
import 'package:torah_library/otzaria_viewer/text_book/view/links_screen.dart';
import 'package:torah_library/otzaria_viewer/widgets/progressive_scrolling.dart';
...
class _CombinedViewState extends State<CombinedView> {
  ...
  Widget buildOuterList(TextBookLoaded state) {
    return ScrollablePositionedList.builder(
      ...
      itemBuilder: (context, index) {
        ExpansionTileController controller = ExpansionTileController(); // תוקן
  ...
  ExpansionTile buildExpansiomTile(
    ExpansionTileController controller, // תוקן
    int index,
